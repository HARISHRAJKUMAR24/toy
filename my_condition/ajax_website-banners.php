...
$advance_category_main_heading = isset($_POST['advance_category_main_heading']) ? $_POST['advance_category_main_heading'] : getData("advance_category_main_heading", "seller_banners", "(seller_id = '$userId' AND store_id = '$storeId')");

for ($i = 1; $i <= 6; $i++) {
	${"advance_category_name_$i"} = isset($_POST["advance_category_name_$i"]) ? $_POST["advance_category_name_$i"] : getData("advance_category_name_$i", "seller_banners", "(seller_id = '$userId' AND store_id = '$storeId')");
	${"advance_category_link_$i"} = isset($_POST["advance_category_link_$i"]) ? $_POST["advance_category_link_$i"] : getData("advance_category_link_$i", "seller_banners", "(seller_id = '$userId' AND store_id = '$storeId')");
	...
	if (!empty($_FILES["advance_category_image_$i"]["name"])) {
		...
		${"advance_category_image_$i"} = getData("advance_category_image_$i", "seller_banners", "(seller_id = '$userId' AND store_id = '$storeId')");
	}
}
