...
if (!empty($cartData)):
    foreach ($cartData as $cart):
        ...
        if (isset($cart['mrp_price']) && $cart['mrp_price'] > $cart['price']) {
            $html .= '<div class="flex items-center justify-between bg-pink-50 text-pink-600 rounded-lg px-3 py-1 mt-1 text-sm">
