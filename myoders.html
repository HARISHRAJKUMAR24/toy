    ...
    <div class="p-6">
      ...
      <ul class="flex flex-col gap-6 font-medium text-gray-700">
        ...
        <li class="mobile-dropdown">
          ...
          <!-- Dropdown Menu -->
          <ul class="pl-4 mt-2 max-h-0 overflow-hidden overflow-y-auto transition-all duration-300 flex flex-col gap-1">
            <li><a href="#" class="block py-2 text-gray-600 hover:text-pink-500 transition-all duration-300">Very
                Long Product Name That Should Wrap</a></li>
            <li><a href="#" class="block py-2 text-gray-600 hover:text-pink-500 transition-all duration-300">Games</a>
            </li>
            <li><a href="#" class="block py-2 text-gray-600 hover:text-pink-500 transition-all duration-300">Gift
                Items</a></li>
