        ...
        <div class="lg:w-[50%] w-full mx-auto">
            <div class="p-6 bg-white rounded-2xl shadow-lg">
                ...
                <form action="<?= $storeUrl ?>order">
                    ...
                    <button class="bg-gradient-to-r from-pink-400 to-pink-600 h-[50px] rounded-xl font-semibold text-base text-white flex items-center justify-center w-full gap-2 hover:from-pink-500 hover:to-pink-700 transition transform hover:scale-105 shadow-lg hover:shadow-xl">
